...
class CreatePixConfig {
    ...
    @Bean
    fun createPixUseCase(createPixRepository: CreatePixRepository, pixSendMessage: PixSendMessage): CreatePixUseCase =
            DbCreatePixUseCase(createPixRepository, pixSendMessage)
}